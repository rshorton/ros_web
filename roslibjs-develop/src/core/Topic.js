...
function Topic(options) {
  ...
  // scott
  this.use_transient_local = options.use_transient_local || false;


console.log('use_transient_local: ' + this.use_transient_local);
...
Topic.prototype.subscribe = function(callback) {
  ...
  this.callForSubscribeAndAdvertise({
    ...
    use_transient_local: this.use_transient_local
  });
};
